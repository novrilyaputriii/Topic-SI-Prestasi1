    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card-body">
                    <form class="row g-3" action="<?php echo e(route('add_proses_user.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Topic-SI-Prestasi1\resources\views/mahasiswa/includes/lomba/modalTambahLomba.blade.php ENDPATH**/ ?>