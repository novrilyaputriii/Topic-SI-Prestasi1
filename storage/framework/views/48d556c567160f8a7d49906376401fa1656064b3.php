    ...
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('hapus_lomba', $item->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\Topic-SI-Prestasi1\resources\views/mahasiswa/includes/lomba/modalHapusLomba.blade.php ENDPATH**/ ?>