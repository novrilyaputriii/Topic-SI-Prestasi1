<!-- Modal Edit Lomba -->
<div class="modal fade" id="modalEditLomba-<?php echo e($item->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row g-3">
                    <form action="<?php echo e(route('admin_update_lomba', ['id' => $item->id])); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="input-group col-12 mb-1">
                            ...
                            <select hidden name="Kelas" class="form-control <?php $__errorArgs = ['Kelas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php /**PATH C:\laragon\www\Topic-SI-Prestasi1\resources\views/admin/includes/lomba/modalEditLomba.blade.php ENDPATH**/ ?>