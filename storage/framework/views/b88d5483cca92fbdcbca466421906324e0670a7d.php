<?php $__env->startSection('content'); ?>
    <div class="app-title">
        <div>
            <h1><i class="app-menu__icon bi bi-people"></i> Manajemen Siswa</h1>
            <p>Laman untuk manajemen data mahasiswa</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><a href="/admin"><i class="bi bi-house-door fs-6"></i></a></li>
            <li class="breadcrumb-item"><a href="/mahasiswa">Manajemen Siswa</a></li>
        </ul>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Topic-SI-Prestasi1\resources\views/admin/mahasiswa.blade.php ENDPATH**/ ?>