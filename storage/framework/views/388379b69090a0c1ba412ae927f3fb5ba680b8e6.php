        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <?php if(auth()->guard()->guest()): ?>
                <div class="d-none d-lg-block">
                    <a href="<?php echo e(url('keluar')); ?>" class="navbar-icon rounded bi bi-box-arrow-in-right smoothscroll">
                        Login</a>
                </div>
            <?php else: ?>
                <div class="d-none d-lg-block">
                ...
                <?php endif; ?>
                <?php if(auth()->check() && auth()->user()->level == 'mahasiswa'): ?>
                    <div class="d-none d-lg-block ms-2">
...
<?php /**PATH C:\laragon\www\Topic-SI-Prestasi1\resources\views/landingpage/includes/navbar.blade.php ENDPATH**/ ?>