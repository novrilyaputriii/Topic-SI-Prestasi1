...
<?php $__env->startSection('content'); ?>
    <div class="app-title">
        <div>
            <h1><i class="bi bi-person-lines-fill"></i> Profil <?php echo e(Auth::user()->name); ?></h1>
            <p>Laman untuk mengatur profil <?php echo e(Auth::user()->name); ?></p>
        </div>
    ...
    <div class="row">
        <div class="col-xl-4 mb-3">
            <div class="card">
                ...
                <form action="<?php echo e(route('admin_update_profil', ['id' => $data->id])); ?>" method="POST"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Topic-SI-Prestasi\resources\views/admin/profil.blade.php ENDPATH**/ ?>