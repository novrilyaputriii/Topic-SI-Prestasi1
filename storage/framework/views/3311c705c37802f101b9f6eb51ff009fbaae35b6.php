                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($item->sertifikat): ?>
                                                <img src="<?php echo e(asset('storage/sertifikat/' . $item->sertifikat)); ?>"
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button class="btn btn-warning" type="button" data-bs-toggle="modal"
                                                        data-bs-target="#modalSetujuLomba-<?php echo e($item->id); ?>">
                                        ...
                                        <?php else: ?>
                                            <td class="text-center">
                                                <button <?php if(true): echo 'readonly'; endif; ?> class="btn btn-success" type="button"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Topic-SI-Prestasi1\resources\views/admin/lomba.blade.php ENDPATH**/ ?>